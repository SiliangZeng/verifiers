...
from verifiers.trainers.remax_env_trainer import ReMaxEnvTrainer

parser = argparse.ArgumentParser(description='Run TriviaQA search example with ReMax')
...
run_name = "triviaqa-remax-wiki-search_" + model_name.split("/")[-1].lower()
