...
parser.add_argument(
    "--learning_rate", type=float, default=1e-6, help="Learning rate (default: 1e-6)"
)
parser.add_argument(
    "--num_generations", type=int, default=21, help="Rollouts per prompt (default: 21)"
)
parser.add_argument(
...
parser.add_argument(
    "--num_iterations", type=int, default=2, help="Number of iterations (default: 2)"
)
parser.add_argument(
    "--max_steps",
    type=int,
